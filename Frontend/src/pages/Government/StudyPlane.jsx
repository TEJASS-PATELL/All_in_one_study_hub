...
import { BarChart2, Brain, Calendar1Icon, CircleDot, Flame, Focus, Leaf, RefreshCcw, Target, Zap } from "lucide-react";
    ...
    <>
      <div className="Gstudy-plan-wrapper">
        ...
        <section className="Gwhy-time-matters">
          <span className="Geyebrow">Time Management Manifesto</span>
      ...
      <div className="Gdivide">
        <section className="Gsection-toggle-container">
          <div className="Gsection-item">
            <h2 className="Gsection-toggle" onClick={() => toggleSection("planning")}>
              <FaRegCircle size={8} color="#1d4ed8" /> Strategic Weekly Planning
              <span className="Garrow">{sections.planning ? "▲" : "▼"}</span>
            </h2>
            {sections.planning && (
          ...
          <div className="Gsection-item">
            <h2 className="Gsection-toggle" onClick={() => toggleSection("dailyGoals")}>
              <FaCircle size={8} color="#1d4ed8" /> Daily Goal Execution & Prioritization
              <span className="Garrow">{sections.dailyGoals ? "▲" : "▼"}</span>
            </h2>
          ...
          <div className="Gsection-item">
            <h2 className="Gsection-toggle" onClick={() => toggleSection("revision")}>
              <FaRegCircle size={8} color="#1d4ed8" /> Effective Revision Techniques
              <span className="Garrow">{sections.revision ? "▲" : "▼"}</span>
            </h2>
            {sections.revision && (
              <div className="Gsection-content">
                <p>
          ...
          <div className="Gsection-item">
            <h2 className="Gsection-toggle" onClick={() => toggleSection("productivity")}>
              <FaCircle size={8} color="#1d4ed8" /> Productivity Frameworks & Boosters
              <span className="Garrow">{sections.productivity ? "▲" : "▼"}</span>
            </h2>
          ...
          <div className="Gsection-item">
            <h2 className="Gsection-toggle" onClick={() => toggleSection("mindset")}>
              <FaRegCircle size={8} color="#1d4ed8" /> Cultivating a Growth Mindset
              <span className="Garrow">{sections.mindset ? "▲" : "▼"}</span>
            </h2>
            {sections.mindset && (
              <div className="Gsection-content">
                <p>
          ...
          <div className="Gsection-item">
            <h2 className="Gsection-toggle" onClick={() => toggleSection("environment")}>
              <FaCircle size={8} color="#1d4ed8" /> Optimized Study Environment
              <span className="Garrow">{sections.environment ? "▲" : "▼"}</span>
            </h2>
          ...
          <div className="Gsection-item">
            <h2 className="Gsection-toggle" onClick={() => toggleSection("focus")}>
              <FaRegCircle size={8} color="#1d4ed8" /> Laser-Focus Techniques
              <span className="Garrow">{sections.focus ? "▲" : "▼"}</span>
            </h2>
            {sections.focus && (
              <div className="Gsection-content">
                <p>
          ...
          <div className="Gsection-item">
            <h2 className="Gsection-toggle" onClick={() => toggleSection("weeklyReview")}>
              <FaCircle size={8} color="#1d4ed8" /> Weekly Review & Reset Ritual
              <span className="Garrow">{sections.weeklyReview ? "▲" : "▼"}</span>
            </h2>
