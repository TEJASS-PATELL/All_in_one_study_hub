...
const ExamDay = () => {
  return (
    <div className="strategy-page">
      <div className="strategy-ledger" aria-hidden="true"></div>

      <header className="strategy-header">
        <span className="strategy-eyebrow">Field Manual — Exam Day</span>
      ...
      <section className="strategy-cards">
        <div className="strategy-card">
          <div className="strategy-body">
            <h2>Smart Question Selection</h2>
            <p>
        ...
        <div className="strategy-card">
          <div className="strategy-body">
            <h2>Structured Time Management</h2>
            <p>
        ...
        <div className="strategy-card">
          <div className="strategy-body">
            <h2>Maintain a Clear Attempt Order</h2>
            <p>
        ...
        <div className="strategy-card">
          <div className="strategy-body">
            <h2>Keep Mind and Body Exam-Ready</h2>
            <p>
        ...
        <div className="strategy-card">
          <div className="strategy-body">
            <h2>Adapt to the Paper in Real Time</h2>
            <p>
        ...
        <div className="strategy-card">
          <div className="strategy-body">
            <h2>Apply Elimination Techniques</h2>
            <p>
